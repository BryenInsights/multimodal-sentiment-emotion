  ...
  async function onSubmit(data: LoginSchema) {
    try {
      ...
      if (!signInResult?.error) {
        ...
        setError(
          signInResult.error === "CredentialSignin"
        ...
        <div className="w-full max-w-md space-y-8 px-4">
          ...
          >
            ...
            <button
              type="submit"
              disabled={loading}
              className="flex w-full justify-center rounded-md bg-gray-800 px-4 py-2 font-medium text-white hover:bg-gray-700 focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 focus:outline-none disabled:opacity-50"
            >
              {loading ? "Logging in..." : "Log in"}
            </button>

            <p className="tect-center text-sm text-gray-600">
